...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        SmartDashboard.putData(switchSideChooser);
        ...
        runner = new MotionProfileRunner(Robot.pathChooser.getSelected(), Robot.driveTrain.getLeftFront(), Robot.driveTrain.getRightFront());
