...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainLeftBack = new TalonSRX(1);
        
        driveTrainLeftFront = new TalonSRX(2);
        ...
        LiveWindow.add(ElevatorSpark); 
        
        ClimberSpark = new Spark(1); 
        LiveWindow.add(ClimberSpark); 
