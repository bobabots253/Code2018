...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.add((Sendable) driveTrainLeftBack);
        
        driveTrainLeftFront = new TalonSRX(1);
        LiveWindow.add((Sendable) driveTrainLeftFront);
        
        driveTrainRightFront = new TalonSRX(2);
        LiveWindow.add((Sendable) driveTrainRightFront);
        
        driveTrainRightBack = new TalonSRX(3);
        LiveWindow.add((Sendable) driveTrainRightBack);
