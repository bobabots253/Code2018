...
public class TrajecLib {
	*//****************************
	...
	public static Trajectory.Config RtoRScaleConfig = new Trajectory.Config(Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_HIGH, Constants.kTimeStepGlobal, 4, 2, 15);
	...
	*//*****************************
	...
	public static Trajectory.Config RtoLScaleConfig = new Trajectory.Config(Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_HIGH, Constants.kTimeStepGlobal, 10, 7, 140);
	...
	*//*************************
	...
	public static Trajectory.Config ScaleUpConfig = new Trajectory.Config(Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_HIGH, Constants.kTimeStepGlobal, 1.5, 0.75, 15);
