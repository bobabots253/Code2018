...
//        ButtonBoard4.whileHeld(new insideEject());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ButtonX.whileHeld(new SpinOpposite());
        ButtonY.whileHeld(new SpinRightIntake());
        //OperatorOne1.whileHeld(new SetElevator(Robot.elevatorChooser.getSelected()));
        ButtonB.whileHeld(new ResetGyro());
        ButtonRB.whileHeld(new SolenoidIntakeForward());
        ButtonLB.whileHeld(new SolenoidIntakeReverse());
        ...
        SmartDashboard.putData("Differential Drive", new ChangeDefault(Robot.driveTrain, new tankDrive()));
        SmartDashboard.putData("Kinect Drive", new ChangeDefault(Robot.driveTrain, new KinectDrive()));
        
        SmartDashboard.putData("Kinect Arms", new ChangeDefault(Robot.arms, new KinectArms()));
    }
