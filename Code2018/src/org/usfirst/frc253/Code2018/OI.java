...
public class OI {
    ...
    public JoystickButton Operator1;
    public JoystickButton Operator4;
    public JoystickButton Operator5;
    public JoystickButton Operator7;
    public JoystickButton Operator8;
    public JoystickButton Operator10;
    public JoystickButton Operator11;
    ...
    public OI() {
        ...
        Operator1 = new JoystickButton(operator, 1);
        Operator4 = new JoystickButton(operator, 4);
        Operator5 = new JoystickButton(operator, 5);
        Operator7 = new JoystickButton(operator, 7);
        Operator8 = new JoystickButton(operator, 8);
        Operator10 = new JoystickButton(operator, 10);
        Operator11 = new JoystickButton(operator, 11);
...
//        ButtonBoard4.whileHeld(new insideEject());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        Operator1.whileHeld(new SetElevator(Robot.elevatorChooser.getSelected()));
        ButtonRB.whileHeld(new swingInT());
        ButtonLB.whileHeld(new swingOutT());
