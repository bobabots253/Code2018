...
//        ButtonBoard4.whileHeld(new insideEject());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        ButtonLB.whileHeld(new ResetGyro());
        ...
        SmartDashboard.putData("Differential Drive", new ChangeToDiffDrive());
		SmartDashboard.putData("Curvature Drive", new ChangeToCurvDrive());
    }
